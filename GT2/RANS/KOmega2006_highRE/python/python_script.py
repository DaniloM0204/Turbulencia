...
#l_pv=data3[:,9]
ws_pv=np.sqrt(data3[:,5]**2.+data3[:,6]**2.+data3[:,7]**2.)
l_pv=data3[:,11]
cf_pv=ws_pv/(0.5*rho*U**2.)

ws_pv1=np.sqrt(data4[:,5]**2.+data4[:,6]**2.+data4[:,7]**2.)
l_pv1=data4[:,12]
cf_pv1=ws_pv1/(0.5*rho*U**2.)
...
plt.plot(data22[:,0],cf_of1,'-',label='OpenFOAM - No WF')
