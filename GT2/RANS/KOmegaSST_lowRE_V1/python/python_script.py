...
plt.plot(ypn[1:],upn[1:],'-o', ms=5, label='OpenFOAM - Omega WF - Current solution')

#Omega WF off
plt.plot(ypn1[1:],upn1[1:],'-o', ms=5, label='OpenFOAM - Omega WF disabled')
...
plt.plot(data2[:,0],cf_of,'-',label='OpenFOAM -Omega WF')

plt.plot(data22[:,0],cf_of1,'-',label='OpenFOAM - Omega WF disabled')
