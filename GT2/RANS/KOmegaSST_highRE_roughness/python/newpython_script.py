...
data11 = np.loadtxt("./no_roughness/profile0_U_wallShearStress.xy",skiprows=0)
data22 = np.loadtxt("./no_roughness/profile1_U_wallShearStress.xy",skiprows=0)
...
plt.plot(ypn[1:],upn[1:],'-o', ms=5, label='OpenFOAM - Roughness')
plt.plot(ypn1[1:],upn1[1:],'-o', ms=5, label='OpenFOAM - No roughness')
